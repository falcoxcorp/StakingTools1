...
export const defaultValue: FilterViewContextValue = { filters: {}, views: {}, loading: false, waitToLoad: false }

// create context
export const FilterViewContext = createContext<FilterViewContextValue>(defaultValue);
