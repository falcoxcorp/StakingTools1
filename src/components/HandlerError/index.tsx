...
const HandlerError = ({ error, errors = {}, networkError, mapError, closable = true }: HandlerErrorProps) => {
    ...
    const currentError = useMemo(() => {
        ...
        return errors[error?.reference] || mapError?.(error) || getError(error) || ERROR;
