...
import { IStandardFee } from "../../hooks/standard/useStandardFeeUpdate"

export const useUpdateFeeService = () => {
  ...
  const onUpdateFee = useCallback(async (config: IStandardFee, method: COIN_ENUM) => {
