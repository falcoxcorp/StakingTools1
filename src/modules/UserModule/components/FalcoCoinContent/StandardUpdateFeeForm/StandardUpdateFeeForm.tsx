...
type StandardUpdateFeeFormProps = {
  contract: IContractCall
  methodCall: COIN_ENUM
  useHook?: any
  useCallHook?: any
}
const StandardUpdateFeeForm = ({ contract, methodCall, useHook = useStandardFeeUpdate, useCallHook }: StandardUpdateFeeFormProps) => {
  ...
  return (
    <Section gap={2}>
      ...
      <Form onSubmit={onSubmit} control={control} id='update-fee-form' isLoading={isLoading}>
...
export default memo(StandardUpdateFeeForm);